    ...
    <>
      <header className="text-white">
        <section className="w-[100%] px-[3.3rem] pt-52 pb-64">
          ...
          <Link
            to="/singup"
            className="rounded-md bg-red-600 px-4 py-[0.8rem] mr-6"
          >
            Start now
          </Link>
          <Link
            to="/singin"
            className="rounded-md bg-white text-black px-4 py-[0.8rem] mr-6"
          >
            Sign In
          </Link>
        </section>
      ...
      <section
        className="sm:grid sm:grid-cols-6 gap-4 w-[100%] px-[2rem] pt-28 pb-28 sm:space-x-10 shadow-2xl bg-white"
        id="about"
      >
        <img
          ...
          <div className="sm:col-span-1 max-w-sm bg-white border border-black-200 rounded-lg shadow mb-6 sm:mb-0">
            <a href="#">
              <img
                ...
                src="https://media.istockphoto.com/id/1266581983/vector/personal-growth-tiny-man-watering-that-growing-plant-from-the-brain-as-metaphor-growth.jpg?s=612x612&w=0&k=20&c=teQvwe7NfK874P6mB2TtIcYcdqlLNQgx-2XsrJGuSDU="
                alt="image mindset"
                width="385"
                height="385"
              />
            ...
            <div className="p-5">
              ...
              <p className="mb-3 font-normal text-black">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Excepturi beatae pariatur doloremque dolore, quis animi porro
                dolores accusamus, error in consequatur omnis quaerat expedita,
                consequuntur cupiditate? Sed dolorum perspiciatis dolores.
              </p>
            </div>
          </div>
          <div className="sm:col-span-1 max-w-sm bg-white border border-black-200 rounded-lg shadow mb-6 sm:mb-0">
            ...
            <ul role="list" className="space-y-5 my-7">
              <li className="flex space-x-3">
                ...
                <span className="text-base font-normal leading-tight text-gray-500">
                  Access to all the platforms where our community shares their
                  victories
                </span>
              </li>
              <li className="flex space-x-3">
                ...
                <span className="text-base font-normal leading-tight text-gray-500">
                  Live mentoring with me and the community
                </span>
              </li>
              <li className="flex space-x-3">
                <svg
              ...
              <li className="flex space-x-3">
                ...
                <span className="text-base font-normal leading-tight text-gray-500">
                  I teach you to increase your income
                </span>
              </li>
            </ul>
            <button
              type="button"
              className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
            >
              Start to be a winner
            </button>
          </div>
        </article>
      </section>
      ...
      <div className="bg-white mx-auto w-full max-w-screen" id="contact">
        <div className="gap-8 px-[10%] py-6 lg:py-8">
          <div>
            <h1 className="mb-6 text-sm font-semibold text-black uppercase">
              Contact with me
            </h1>
